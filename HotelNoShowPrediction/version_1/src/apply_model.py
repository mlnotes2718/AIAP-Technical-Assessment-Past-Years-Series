...
# Load the dataset
try:
    X_train = pd.read_csv('./data/X_train.csv', index_col='booking_id')
    y_train = pd.read_csv('./data/y_train.csv', index_col='booking_id')
    X_test = pd.read_csv('./data/X_test.csv', index_col='booking_id')
    y_test = pd.read_csv('./data/y_test.csv', index_col='booking_id')
except Exception as e:
...
if not best_model_pkl_list:
    ...
    for model_file in pkl_path_list:
        ...
        log_and_print(f'Accuracy Score for Training Dataset: {best_model.score(X_train, y_train)}')
        log_and_print(f'Accuracy Score for Test Dataset: {best_model.score(X_test, y_test)}')
        log_and_print('-----------------------------------------------------------------------')
...
if not best_model_list:
    ...
    for model_name in best_model_list:
        ...
        log_and_print(f'Accuracy Score for Training Dataset: {pipeline.score(X_train, y_train)}')
        log_and_print(f'Accuracy Score for Test Dataset: {pipeline.score(X_test, y_test)}')
        log_and_print('-----------------------------------------------------------------------')
